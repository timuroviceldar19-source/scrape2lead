...
const dbPath = "data/scrape2lead-kaspi.db";
const exportDir = "exports";

const storage = new Storage(dbPath);

// Pull every lead, regardless of status. The exporter already sorts by
// lead_score DESC; the order in the workbook reflects the priority
// for the sales team.
...
// Tally by crm_status so we can confirm the export is complete.
