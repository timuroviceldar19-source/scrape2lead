...
const COMPANY_COLUMNS: Array<{ header: string; key: keyof CompanyCard; width: number }> = [
  ...
  { header: "Телефон (goszakup)", key: "registry_phone", width: 22 },
  { header: "Email (goszakup)", key: "registry_email", width: 28 },
  { header: "Сайт (goszakup)", key: "registry_website", width: 28 },
  { header: "№ участника goszakup", key: "participant_id", width: 22 },
  { header: "Роль в реестре", key: "registry_role", width: 22 },
